...
public class Main {
	...
	public static void main(String[] args) {
		...
		//Java provides functionality to change the capitalization of a string variable. 
		//You can make all of the letters uppercase or
		//lowercase if you wish by appending .toUpperCase() and .toLowerCase() to the end of the variables respectively. 
